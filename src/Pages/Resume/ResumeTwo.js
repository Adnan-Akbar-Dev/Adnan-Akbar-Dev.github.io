            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              <div className="col-span-1">
                ...
                <div className="flex gap-y-5 gap-x-2.5 flex-wrap">
                  ...
                  <button className="resume-btn">Vue JS</button>
                  <button className="resume-btn">ReactJS</button>
                  <button className="resume-btn">Laravel</button>
                  <button className="resume-btn">Yii2</button>
                  <button className="resume-btn">CodeIgniter</button>
                  <button className="resume-btn">Pinia</button>
                  <button className="resume-btn">Vuex</button>
                </div>
              </div>
