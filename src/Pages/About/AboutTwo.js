                ...
                <div className="col-span-12 space-y-2.5">
                  <div className="lg:mr-16">
                    <p className="leading-7 text-gray-lite dark:text-color-910">
                     A results-oriented Full-Stack Engineer with 6+ years of proven expertise
                    in designing and deploying scalable, high-performance applications.
                    Known for streamlining workflows and enhancing system productivity
                    through innovative problem-solving and adaptive strategies. Committed
                    to delivering exceptional solutions that drive business success and
