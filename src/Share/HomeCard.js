      ...
      <div className="w-full mb-6 lg:mb-0  mx-auto   relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0 ">
        ...
        <div className="pt-[100px] pb-8">
          ...
          <div className="flex justify-center space-x-3">
            <a
              href="https://github.com/Adnan-Akbar-Dev"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/adnan-akbar-9b6052190/"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="p-7 rounded-2xl mt-7  bg-[#F3F6F6] dark:bg-[#1D1D1D]">
            ...
            <div className="flex  border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
              ...
              <div className="text-left ml-2.5">
                ...
                <p className="break-all dark:text-white">
                  ...
                  <a
                    className="hover:text-[#FA5252] duration-300 transition"
                    href="mailto:adnanakbar959@gmail.com"
                  >
                    adnanakbar959@gmail.com
                  </a>
                </p>
              </div>
            </div>
            ...
            <div className="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
              ...
              <div className="text-left ml-2.5">
                ...
                <p className="break-all dark:text-white">Lahore, Pakistan</p>
              </div>
            </div>
